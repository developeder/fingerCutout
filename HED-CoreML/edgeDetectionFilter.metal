...
extern "C" { namespace coreimage {
    ...
    float4 edgeDetection (sampler src, float4 color, float4 color1, float4 color2, float4 color3, float4 color4, float4 color5, float tolerance, float x, float y, float width, float height, float radius)
    {
